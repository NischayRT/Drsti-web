    ...
    return (
      <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 24, background: 'var(--bg)', padding: 40 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 16 }}>
          ...
          <span style={{ fontSize: 14, fontWeight: 500, letterSpacing: '0.18em' }}>Drsti</span>
        </div>
    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg)' }}>
      ...
      <nav style={{
        ...
        <Link href="/" style={{ display: 'flex', alignItems: 'center', gap: 10, textDecoration: 'none' }}>
          ...
          <span style={{ fontSize: 13, fontWeight: 500, letterSpacing: '0.18em', color: 'var(--text)' }}>Drsti</span>
        </Link>
